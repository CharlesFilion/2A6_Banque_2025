...
while (true)
{
    ...
    Console.WriteLine("""
     ...
     Votre choix, Charles-Étienne Filion ?
    ...
    switch (Console.ReadKey(true).KeyChar)
    {
        ...
        case '2':
            ...
            break;
        case '3':
            Console.WriteLine(new Compte(1003, "Mme Création gelée", 1_111_111, Compte.StatutCompte.Gelé).Description());
            break;
        case '4': // Déposer
            {
        ...
        case 'd':  // erreurs de retrait et dépôt
            {
                var ok = new Compte(1009, "Obiwan", 7000);
                var gelé = new Compte(1009, "Obiwan", 7000, Compte.StatutCompte.Gelé);
                (string, string?)[] erreurs =
                {
        ...
        case 'e':  // erreurs pour geler, dégeler et vider
            {
                ...
                var gelé = new Compte(1009, "Obiwan", 10, Compte.StatutCompte.Gelé);
                (string, string?)[] erreurs =
                {
